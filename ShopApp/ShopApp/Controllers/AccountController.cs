    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    MigrateShoppingCart(model.UserName);
                    var user0 = HttpContext.User.Identity.IsAuthenticated;
                    FormsAuthentication.SetAuthCookie(model.UserName, true /*createPersistentCookie */);
                    var user1 = HttpContext.User.Identity.IsAuthenticated;
                    FormsAuthentication.SetAuthCookie(model.Email.ToString(), false);
                    var user2 = HttpContext.User.Identity.IsAuthenticated;
                    return RedirectToAction("Index", "Home");
                }
                else
                {
