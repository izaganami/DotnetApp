...
namespace JaBak
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            // Autoriser l’application à utiliser un cookie pour reserverer des informations pour l’utilisateur connecté
            // et pour utiliser un cookie à des fins de reserverage temporaire des informations sur la connexion utilisateur avec un fournisseur de connexion tiers
            ...
            // Permet à l'application de reserverer temporairement les informations utilisateur lors de la vérification du second facteur dans le processus d'authentification à 2 facteurs.
